    ...
    const markup = images.map((img)=>`
      <li class="image-item">
        <article class="image-card">
          ...
          <ul class="image-info">
            <li>\u{2764} ${img.likes}</li>
            <li>\u{1F441} ${img.views}</li>
            <li>\u{1F4AC} ${img.comments}</li>
            <li>\u{2B07} ${img.downloads}</li>
          </ul>
        </article>
      </li>`).join("");
...
},{}]},["kxwl6","jOXmm"], "jOXmm", "parcelRequire9ffa", {})

//# sourceMappingURL=mini_project.e02fbd41.js.map
